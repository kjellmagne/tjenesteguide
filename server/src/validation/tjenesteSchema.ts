...
export const TjenesteSchema = z.object({
  ...
  for_du_søker_plain_text: z.string().optional(),
  for_du_søker_rich_base64: z.string().optional(),
  beskrivelse: z.string(),
  ...
  tildelingskriterier_plain_text: z.string().optional(),
  tildelingskriterier_rich_base64: z.string().optional(),
  dette_inngår_ikke_i_tjenestetilbudet: z.array(z.string()).optional(),
  dette_inngår_ikke_i_tjenestetilbudet_plain_text: z.string().optional(),
  dette_inngår_ikke_i_tjenestetilbudet_rich_base64: z.string().optional(),
  ...
  hva_kan_du_forvente_plain_text: z.string().optional(),
  hva_kan_du_forvente_rich_base64: z.string().optional(),
  forventninger_til_bruker: z.array(z.string()).optional(),
  forventninger_til_bruker_plain_text: z.string().optional(),
  forventninger_til_bruker_rich_base64: z.string().optional(),
